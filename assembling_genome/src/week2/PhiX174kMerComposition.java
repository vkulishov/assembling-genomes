...
/**
 * Solution for problem 4 of week 2.
 * Assembling the phi X174 Genome from its 𝑘-mer Composition.
 */
public class PhiX174kMerComposition {
    private static final int DEFAULT_READS_NUMBER = 5396;
    ...
    public static void main(String... args) {
        ...
        // Solve the problem.
        PhiX174kMerComposition instance = new PhiX174kMerComposition();
        String genome = instance.assemblyGenome(reads);
    ...
    /**
     * Asembly a genome from the provided list of kmers.
     */
    String assemblyGenome(Collection<String> kmers) {
    ...
    DeBruijnGraph buildDeBruijnGraph(Collection<String> kmers) {
        DeBruijnGraph result = new DeBruijnGraph();
